...
import "../../styles/Contactissen.css"



function ContactsAlfiseen () {
    return(
        <>
      ...
      <div className="contactIssen">
        <div className="contenuIssen">
          <h1>Contactez ALF ISSEN</h1>
          <h5>
            {" "}
        ...
        <div className="form">
          ...
          <form action="">
            ...
            ></textarea>
            <button className="buttonIssen" type="submit" >Envoyer</button>
          </form>
        </div>
      </div>
        </>
...
export default ContactsAlfiseen;